...
```bash
git clone --recursive https://github.com/lukagray-dev/Dybuk.git
cd Dybuk
```
...
Thank you for contributing to Dybuk! If you have any questions, feel free to open a discussion or reach out to us at `[heylukagray@gmail.com]`.
