//! Titlebar menu action handlers (external links, app exit).

use std::process::Command;
use tauri::AppHandle;

pub const DOCUMENTATION_URL: &str = "https://github.com/lukagray-dev/Dybuk/tree/main/docs";
pub const REPORT_BUG_URL: &str = "https://github.com/lukagray-dev/Dybuk/issues";
pub const FOLLOW_CREATOR_URL: &str = "https://www.instagram.com/lukagray.official/";
pub const REPOSITORY_URL: &str = "https://github.com/lukagray-dev/Dybuk";

/// Platform-specific URL launcher without requiring external browser dependencies.
#[tauri::command]
